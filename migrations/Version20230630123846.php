 ...
 */
final class Version20230630123846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE edu_and_production_complex (id INT AUTO_INCREMENT NOT NULL, text VARCHAR(800) NOT NULL, photo LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
